...
namespace P4ECustomControls.P4EControls
{
    public class P4EDropdownMenu : ContextMenuStrip
    {
        //Fields
        ...
        //Constructor
        public P4EDropdownMenu(IContainer container)
            : base(container)
        {
